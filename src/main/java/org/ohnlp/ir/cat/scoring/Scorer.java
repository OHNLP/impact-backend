...
public abstract class Scorer {
    ...
    public Scorer(EHRDataSource dataSource) {
     ...
     */
    public abstract PCollection<KV<KV<String, String>, PatientScore>> score(Pipeline p, Map<String, Set<CriterionValue>> query, ClinicalDataType queryType);
}
